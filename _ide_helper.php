 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \Xiaohuilam\LaravelResponseSuccess\ResponseServiceProvider::register()
         * @param mixed $data
         * @param mixed $meta
         * @static 
         */ 
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::success($data, $meta);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::error($code, $message);
        }
...
')
     ...
     */ 
        ...
        {
                        /** @var \XiaohuiLam\Laravel\WechatAppLogin\WechatAppLogin $instance */
                        return $instance->login($code);
        }
...
namespace  { 
            ...
            class WechatLogin extends \XiaohuiLam\Laravel\WechatAppLogin\Facade {}
